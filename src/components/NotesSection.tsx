    ...
    <div className="w-full h-full flex flex-col bg-transparent relative">      
      ...
      <div className="flex-1 flex flex-col relative w-full h-full">
         <textarea
           ...
           placeholder="Monthly Memos..."
           className="w-full flex-1 resize-none bg-transparent outline-none text-xs text-slate-700 placeholder:text-slate-400 border-none px-1"
         />
        ...
        {selectedStart ? (
          <motion.textarea
            ...
            placeholder={selectedEnd ? "Range notes (applied to all days)..." : "Specific notes..."}
            className="w-full flex-1 resize-none bg-transparent outline-none text-xs text-slate-700 placeholder:text-slate-400 border-none px-1"
          />
        ) : (
          <motion.div 
